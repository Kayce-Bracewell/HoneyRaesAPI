...
var connectionString = "Host=localhost;Port=5432;Username=postgres;Password=Q912s4TjXl5;Database=HoneyRaes";
List<Customer> customers = new List<Customer>
{
    new Customer()
    {
        Id = 1,
        Name = "Babby Brennon",
        Address = "7426 Sumner Hall Dr."
    },
    new Customer()
    {
        Id = 2,
        Name = "Lucas Denetro",
        Address = "4356 Bridle Dr."
    },
    new Customer()
    {
        Id = 3,
        Name = "Jack Aubrey",
        Address = "8933 Pirate Ship Cv."
    }
};
...
List<ServiceTicket> serviceTickets = new List<ServiceTicket>
{
    new ServiceTicket()
    {
        Id = 1,
        CustomerId = 1,
        Description = "My electronic dont work no more.",
        Emergency = false
    },
    new ServiceTicket()
    {
        ...
        CustomerId = 2,
        EmployeeId = 1,
        Description = "TV commited a mortal sin",
        Emergency = false,
    ...
    new ServiceTicket()
    {
        Id = 3,
        CustomerId = 1,
        Description = "Need a life coach. I suck.",
        Emergency = false
    },
    new ServiceTicket()
    {
        ...
        CustomerId = 3,
        EmployeeId = 2,
        Description = "My sailors keep getting scurvy. HALP",
        Emergency = true,
        DateCompleted = new DateTime()
    }
};
